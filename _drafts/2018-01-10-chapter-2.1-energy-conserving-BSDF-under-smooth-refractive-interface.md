...
<img src="../images/SRAL/RefrBsdfGeomBasic.svg" alt="" width="600" />
</p>

where  $f_{s1}$ is the smooth interface, $f_{s2}$ is the given BSDF, $\eta_0$, $\eta_1$, and $\eta_2$ are the refractive indices of media separated by the layers, $N_g$ is the geometrical normal of the surface.
