...
This is the third chapter of the the blog post [A Journey to the World of Layered Surface Materials](a-journey-to-the-world-of-layered-surface-materials.html). Here I will explain how to obtain a correct energy-conserving BSDF for a given BSDF seen and illuminated through a smooth refractive interface with a single scattering event simplification. To do that, I will first define a few basic radiometric quantities and BSDF and finally, I will derive the BSDF for model under a smooth refractive interface. Note that this explanation ignores the reflection contribution of the smooth interface above the given BSDF for clarity!
